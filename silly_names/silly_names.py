"""Generate funny random names from 2 different name lists"""
import random
import sys


def main():
    """Runs a continuous loop that will randomly select a first and last name
    from a list of names until the user types 'n'. """
